...
----------------------------------
1. Check that you have the latest version of :code:`unittest_templates`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/cthoyt/unittest-templates/issues
...
1. Get the code. Fork the repository from GitHub using the big green button in the top-right corner of
   https://github.com/cthoyt/unittest-templates
2. Clone your directory with

.. code-block:: sh

    $ git clone https://github.com/<YourUsername>/unittest-templates
...
If you spend a while working on your changes, further commits may be made to the main :code:`unittest_templates`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/cthoyt/unittest-templates
